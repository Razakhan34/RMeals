...
export const getNearbyRestaurantsRequest = () => ({
  type: actionTypes.GET_NEARBY_RESTAURANT_REQUEST,
});

export const getNearbyRestaurantsSuccess = (restaurants) => ({
  type: actionTypes.GET_NEARBY_RESTAURANT_SUCCESS,
  payload: restaurants,
});

export const getNearbyRestaurantsFailure = (error) => ({
  type: actionTypes.GET_NEARBY_RESTAURANT_FAILURE,
  payload: error,
});
