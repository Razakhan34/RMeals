...
// create SEARCH_POPULAR_CUISINES_MENU_ITEM action creators
export const searchPopularCuisinesMenuItemRequest = () => ({
  type: actionTypes.SEARCH_POPULAR_CUISINES_MENU_ITEM_REQUEST,
});

export const searchPopularCuisinesMenuItemSuccess = (menuItems) => ({
  type: actionTypes.SEARCH_POPULAR_CUISINES_MENU_ITEM_SUCCESS,
  payload: menuItems,
});

export const searchPopularCuisinesMenuItemFailure = (error) => ({
  type: actionTypes.SEARCH_POPULAR_CUISINES_MENU_ITEM_FAILURE,
  payload: error,
});
