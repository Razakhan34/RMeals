...
const menuItemReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.SEARCH_POPULAR_CUISINES_MENU_ITEM_REQUEST:
      return {
        ...state,
        loading: true,
        error: null,
    ...
    case actionTypes.SEARCH_POPULAR_CUISINES_MENU_ITEM_SUCCESS:
      return {
        ...state,
        loading: false,
    ...
    case actionTypes.SEARCH_POPULAR_CUISINES_MENU_ITEM_FAILURE:
      return {
        ...state,
        loading: false,
